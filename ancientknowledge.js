...
var TableCenter = /** @class */ (function () {
  function TableCenter(game, gamedatas) {
    ...
    [1, 2, 3].forEach(function (number) {
      _this.technologyTilesStocks[number] = new SlotStock(
        game.technologyTilesManager,
  ...
  function PlayerTable(game, player) {
    ...
    if (this.currentPlayer) {
      ...
      this.hand = new LineStock(this.game.builderCardsManager, handDiv, {
        sort: function (a, b) {
          return a.type == b.type ? a.number - b.number : a.type - b.type;
        },
      });
...
var AncientKnowledge = /** @class */ (function () {
  ...
  AncientKnowledge.prototype.setGamestateDescription = function (property) {
    if (property === void 0) {
      property = '';
    }
  ...
  AncientKnowledge.prototype.onEnteringPlayAction = function (args) {
    var _a;
  ...
  AncientKnowledge.prototype.onEnteringChooseNewCard = function (args) {
    if (this.isCurrentPlayerActive()) {
      this.tableCenter.setCardsSelectable(true, args.allFree ? null : args.freeColor, args.recruits);
    }
  };
  AncientKnowledge.prototype.onEnteringDiscardTableCard = function () {
    if (this.isCurrentPlayerActive()) {
      this.tableCenter.setCardsSelectable(true, null, 0);
    }
  };
  AncientKnowledge.prototype.onEnteringDiscardCard = function (args) {
    var _a;
    if (this.isCurrentPlayerActive()) {
      (_a = this.getCurrentPlayerTable()) === null || _a === void 0 ? void 0 : _a.setCardsSelectable(true, [0]);
    }
  };
  AncientKnowledge.prototype.onEnteringPayDestination = function (args) {
    var _a;
    var selectedCardDiv = this.technologyTilesManager.getCardElement(args.selectedDestination);
    selectedCardDiv.classList.add('selected-pay-destination');
    if (this.isCurrentPlayerActive()) {
      (_a = this.getCurrentPlayerTable()) === null || _a === void 0
        ? void 0
        : _a.setCardsSelectable(true, args.selectedDestination.cost);
    }
  };
  AncientKnowledge.prototype.onEnteringReserveDestination = function () {
    if (this.isCurrentPlayerActive()) {
  ...
  AncientKnowledge.prototype.onLeavingPlayAction = function () {
    var _a, _b;
  ...
  AncientKnowledge.prototype.onLeavingChooseNewCard = function () {
    this.tableCenter.setCardsSelectable(false);
  };
  AncientKnowledge.prototype.onLeavingPayDestination = function () {
    var _a;
    document.querySelectorAll('.selected-pay-destination').forEach(function (elem) {
      return elem.classList.remove('selected-pay-destination');
    });
    (_a = this.getCurrentPlayerTable()) === null || _a === void 0 ? void 0 : _a.setCardsSelectable(false);
  };
  AncientKnowledge.prototype.onLeavingDiscardTableCard = function () {
    this.tableCenter.setCardsSelectable(false);
  };
  AncientKnowledge.prototype.onLeavingDiscardCard = function () {
    var _a;
    (_a = this.getCurrentPlayerTable()) === null || _a === void 0 ? void 0 : _a.setCardsSelectable(false);
  };
  AncientKnowledge.prototype.onLeavingReserveDestination = function () {
    this.tableCenter.setTechonologyTilesSelectable(false);
  };
  AncientKnowledge.prototype.setPayDestinationLabelAndState = function (args) {
    if (!args) {
    ...
    var total = Object.values(args.selectedDestination.cost).reduce(function (a, b) {
      return a + b;
    }, 0);
    ...
    if (this.isCurrentPlayerActive()) {
      switch (stateName) {
        case 'playAction':
          ...
          this.addActionButton('goTrade_button', _('Trade'), function () {
            return _this.goTrade();
          });
          ...
          if (!playActionArgs.canExplore || !playActionArgs.canRecruit) {
            this.addActionButton('endTurn_button', _('End turn'), function () {
        ...
        case 'chooseNewCard':
          ...
          [1, 2, 3, 4, 5].forEach(function (color) {
            ...
            _this.addActionButton(
              'chooseNewCard'.concat(color, '_button'),
              _('Take ${color}').replace('${color}', '<div class="color" data-color="'.concat(color, '"></div>')) +
                ' ('.concat(free ? _('free') : '1 <div class="recruit icon"></div>', ')'),
              function () {
                return _this.chooseNewCard(
                  chooseNewCardArgs_1.centerCards.find(function (card) {
                    return card.locationArg == color;
                  }).id
                );
              },
              null,
          ...
          break;
        case 'payDestination':
          this.addActionButton('payDestination_button', '', function () {
            return _this.payDestination();
          });
        ...
        case 'trade':
          ...
          [1, 2, 3].forEach(function (number) {
            _this.addActionButton(
              'trade'.concat(number, '_button'),
              _('Trade ${number} bracelet(s)').replace('${number}', number),
              function () {
                return _this.trade(number, tradeArgs_1.gainsByBracelets);
              }
            );
            ...
            if (tradeArgs_1.bracelets < number) {
              ...
              button.addEventListener('mouseenter', function () {
                return _this.getCurrentPlayerTable().showColumns(number);
              });
              button.addEventListener('mouseleave', function () {
                return _this.getCurrentPlayerTable().showColumns(0);
              });
            }
          });
          this.addActionButton(
  ...
  AncientKnowledge.prototype.getBoatSide = function () {
    return this.gamedatas.boatSideOption;
  };
  AncientKnowledge.prototype.getVariantOption = function () {
  ...
  AncientKnowledge.prototype.createPlayerPanels = function (gamedatas) {
    ...
    Object.values(gamedatas.players).forEach(function (player) {
      ...
      var html = '<div class="counters">\n            \n                <div id="reputation-counter-wrapper-'
        ...
        .concat(player.id, '"></span> <span class="reputation-legend"><div class="vp icon"></div> / ')
        .concat(
          _('round'),
  ...
  AncientKnowledge.prototype.goTrade = function () {
    if (!this.checkAction('goTrade')) {
      return;
    }
    this.takeAction('goTrade');
  };
  AncientKnowledge.prototype.playCard = function (id) {
  ...
  AncientKnowledge.prototype.takeDestination = function (id) {
  ...
  AncientKnowledge.prototype.reserveDestination = function (id) {
  ...
  AncientKnowledge.prototype.chooseNewCard = function (id) {
  ...
  AncientKnowledge.prototype.payDestination = function () {
    if (!this.checkAction('payDestination')) {
      return;
    }
    var ids = this.getCurrentPlayerTable()
      .getSelectedCards()
      .map(function (card) {
        return card.id;
      });
  ...
  AncientKnowledge.prototype.trade = function (number, gainsByBracelets) {
    var _this = this;
    ...
    if (gainsByBracelets != null) {
      if (gainsByBracelets[number] == 0) {
        warning =
          _('Are you sure you want to trade ${bracelets} bracelet(s) ?').replace('${bracelets}', number) +
          ' ' +
          _('There is nothing to gain yet with this number of bracelet(s)');
      } else if (number > 1 && gainsByBracelets[number] == gainsByBracelets[number - 1]) {
        warning =
          _('Are you sure you want to trade ${bracelets} bracelet(s) ?').replace('${bracelets}', number) +
          ' ' +
          _('You would gain the same with one less bracelet');
      }
    }
    if (warning != null) {
      this.confirmationDialog(warning, function () {
        return _this.trade(number, null);
      });
      return;
    }
  ...
  AncientKnowledge.prototype.cancel = function () {
    if (!this.checkAction('cancel')) {
      return;
    }
    this.takeAction('cancel');
  };
  AncientKnowledge.prototype.endTurn = function () {
    if (!this.checkAction('endTurn')) {
      return;
    }
    this.takeAction('endTurn');
  };
  AncientKnowledge.prototype.discardTableCard = function (id) {
  ...
  AncientKnowledge.prototype.discardCard = function (id) {
  ...
  AncientKnowledge.prototype.notif_playCard = function (args) {
  ...
  AncientKnowledge.prototype.notif_takeDestination = function (args) {
    var playerId = args.playerId;
  ...
  AncientKnowledge.prototype.notif_discardCards = function (args) {
    var _this = this;
    return this.tableCenter.cardDiscard.addCards(args.cards, undefined, undefined, 50).then(function () {
      return _this.tableCenter.setDiscardCount(args.cardDiscardCount);
    });
  };
  AncientKnowledge.prototype.notif_newTableDestination = function (args) {
    return this.tableCenter.newTableDestination(
      args.destination,
      args.letter,
      args.destinationDeckCount,
      args.destinationDeckTop
    );
  };
  AncientKnowledge.prototype.notif_score = function (args) {
    this.setScore(args.playerId, +args.newScore);
  };
  AncientKnowledge.prototype.notif_bracelet = function (args) {
    this.setBracelets(args.playerId, +args.newScore);
  };
  AncientKnowledge.prototype.notif_recruit = function (args) {
    this.setRecruits(args.playerId, +args.newScore);
  };
  AncientKnowledge.prototype.notif_trade = function (args) {
    var playerId = args.playerId;
    this.updateGains(playerId, args.effectiveGains);
  };
  AncientKnowledge.prototype.notif_takeDeckCard = function (args) {
    var playerId = args.playerId;
    var playerTable = this.getPlayerTable(playerId);
  ...
  AncientKnowledge.prototype.notif_discardTableCard = function (args) {
    return this.tableCenter.cardDiscard.addCard(args.card);
  };
  AncientKnowledge.prototype.notif_reserveDestination = function (args) {
    var playerId = args.playerId;
    var playerTable = this.getPlayerTable(playerId);
    return playerTable.reserveDestination(args.destination);
  };
  AncientKnowledge.prototype.notif_cardDeckReset = function (args) {
    this.tableCenter.cardDeck.setCardNumber(args.cardDeckCount, args.cardDeckTop);
   ...
   */
  AncientKnowledge.prototype.notif_lastTurn = function (animate) {
    if (animate === void 0) {
      animate = true;
    }
    dojo.place(
