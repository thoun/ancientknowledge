...
function slideToAnimation(animationManager, animation) {
  var promise = new Promise(function (success) {
    ...
    element.style.zIndex = ''.concat(
      (_c = settings === null || settings === void 0 ? void 0 : settings.zIndex) !== null && _c !== void 0 ? _c : 10
    );
    var timeoutId = null;
    ...
    element.style.transform = 'translate('
      ...
      .concat(-y, 'px) rotate(')
      .concat(
        (_d = settings === null || settings === void 0 ? void 0 : settings.rotationDelta) !== null && _d !== void 0 ? _d : 0,
        'deg) scale('
      )
...
function slideAnimation(animationManager, animation) {
  var promise = new Promise(function (success) {
    ...
    element.offsetHeight;
    element.style.transform =
      (_e = settings === null || settings === void 0 ? void 0 : settings.finalTransform) !== null && _e !== void 0 ? _e : null;
    // safety in case transitionend and transitioncancel are not called
    timeoutId = setTimeout(cleanOnTransitionEnd, duration + 100);
  });
  return promise;
        ...
        switch (_s.label) {
            ...
            animation.settings = __assign(
              {
                duration:
                  (_g =
                    (_e = (_d = animation.settings) === null || _d === void 0 ? void 0 : _d.duration) !== null && _e !== void 0
                      ? _e
                ...
                scale:
                  (_l =
                    (_j = (_h = animation.settings) === null || _h === void 0 ? void 0 : _h.scale) !== null && _j !== void 0
                      ? _j
          ...
          case 1:
            ...
            (_p = settings.element) === null || _p === void 0
              ? void 0
              : _p.classList.remove((_q = settings.animationClass) !== null && _q !== void 0 ? _q : 'bga-animations_animated');
            return [3 /*break*/, 3];
          case 2:
...
var CardStock = /** @class */ (function () {
  ...
  CardStock.prototype.addCard = function (card, animation, settings) {
    ...
    if (originStock === null || originStock === void 0 ? void 0 : originStock.contains(card)) {
      ...
      (_c = animation === null || animation === void 0 ? void 0 : animation.fromStock) === null || _c === void 0
        ? void 0
        : _c.contains(card)
    ) {
      var element = this.getCardElement(card);
    ...
    if (needsCreation) {
      var element = this.manager.createCardElement(
        card,
        (_d = settingsWithIndex === null || settingsWithIndex === void 0 ? void 0 : settingsWithIndex.visible) !== null &&
          _d !== void 0
          ? _d
          : this.manager.isCardVisible(card)
      );
...
var Deck = /** @class */ (function (_super) {
  ...
  function Deck(manager, element, settings) {
    ...
    _this.fakeCardGenerator =
      (_a = settings === null || settings === void 0 ? void 0 : settings.fakeCardGenerator) !== null && _a !== void 0
        ? _a
        : manager.getFakeCardGenerator();
    ...
    if (settings.counter && ((_g = settings.counter.show) !== null && _g !== void 0 ? _g : true)) {
      ...
      _this.createCounter(
        (_h = settings.counter.position) !== null && _h !== void 0 ? _h : 'bottom',
        (_j = settings.counter.extraClasses) !== null && _j !== void 0 ? _j : 'round',
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            animatedCardsMax =
              (_a = settings === null || settings === void 0 ? void 0 : settings.animatedCardsMax) !== null && _a !== void 0
                ? _a
                : 10;
            this.addCard(
              (_b = settings === null || settings === void 0 ? void 0 : settings.newTopCard) !== null && _b !== void 0
                ? _b
                : this.getFakeCard(),
              undefined,
          ...
          case 1:
            _d.sent();
            pauseDelayAfterAnimation =
              (_c = settings === null || settings === void 0 ? void 0 : settings.pauseDelayAfterAnimation) !== null &&
              _c !== void 0
                ? _c
                : 500;
            ...
            return [
              4 /*yield*/,
              this.manager.animationManager.play(new BgaPauseAnimation({ duration: pauseDelayAfterAnimation })),
            ];
          case 2:
            _d.sent();
            _d.label = 3;
...
var AllVisibleDeck = /** @class */ (function (_super) {
  ...
  function AllVisibleDeck(manager, element, settings) {
    ...
    element.style.setProperty(
      '--vertical-shift',
      (_c = (_b = settings.verticalShift) !== null && _b !== void 0 ? _b : settings.shift) !== null && _c !== void 0 ? _c : '3px'
    );
    element.style.setProperty(
      '--horizontal-shift',
      (_e = (_d = settings.horizontalShift) !== null && _d !== void 0 ? _d : settings.shift) !== null && _e !== void 0
        ? _e
        : '3px'
    );
...
var CardManager = /** @class */ (function () {
  ...
  CardManager.prototype.setCardVisible = function (card, visible, settings) {
    ...
    if ((_a = settings === null || settings === void 0 ? void 0 : settings.updateMain) !== null && _a !== void 0 ? _a : false) {
      ...
      var updateMainDelay =
        (_b = settings === null || settings === void 0 ? void 0 : settings.updateMainDelay) !== null && _b !== void 0 ? _b : 0;
      if (isVisible && updateMainDelay > 0 && this.animationsActive()) {
        this.updateMainTimeoutId[stringId] = setTimeout(function () {
          var _a, _b;
          return (_b = (_a = _this.settings).setupDiv) === null || _b === void 0 ? void 0 : _b.call(_a, card, element);
        }, updateMainDelay);
      } else {
    ...
    if ((_e = settings === null || settings === void 0 ? void 0 : settings.updateFront) !== null && _e !== void 0 ? _e : true) {
      ...
      var updateFrontDelay =
        (_f = settings === null || settings === void 0 ? void 0 : settings.updateFrontDelay) !== null && _f !== void 0 ? _f : 500;
      if (!isVisible && updateFrontDelay > 0 && this.animationsActive()) {
        ...
        (_h = (_g = this.settings).setupFrontDiv) === null || _h === void 0
          ? void 0
          : _h.call(_g, card, element.getElementsByClassName('front')[0]);
      }
    }
    if ((_j = settings === null || settings === void 0 ? void 0 : settings.updateBack) !== null && _j !== void 0 ? _j : false) {
      ...
      var updateBackDelay =
        (_k = settings === null || settings === void 0 ? void 0 : settings.updateBackDelay) !== null && _k !== void 0 ? _k : 0;
      if (isVisible && updateBackDelay > 0 && this.animationsActive()) {
        ...
        (_m = (_l = this.settings).setupBackDiv) === null || _m === void 0
          ? void 0
          : _m.call(_l, card, element.getElementsByClassName('back')[0]);
      }
    }
  ...
  CardManager.prototype.getFakeCardGenerator = function () {
    var _this = this;
    var _a, _b;
    return (_b = (_a = this.settings) === null || _a === void 0 ? void 0 : _a.fakeCardGenerator) !== null && _b !== void 0
      ? _b
      : function (deckId) {
          return { id: _this.getId({ id: ''.concat(deckId, '-fake-top-card') }) };
        };
  };
  return CardManager;
})();
var CARDS_DATA = {
  ...
  M15_BarabarCaves: {
    ...
    lockedSpace: false,
    activation: 'decline',
    effect: ["Choose 1 monument in one of your opponents' Timelines and place up to 3 <LOST_KNOWLEDGE> from your board onto it."],
  },
  M16_DiquisStoneSpheres: {
    ...
    lockedSpace: false,
    activation: 'immediate',
    effect: ['You may CREATE 1 <ARTIFACT>.'],
  },
  M17_FortSamaipata: {
    type: 'megalith',
    number: 17,
  ...
  M26_ChabolaDeLaHechicera: {
    ...
    activation: 'anytime',
    effect: [
      'Each time you CREATE 1 <ARTIFACT> :\n\u2022 discard 1 <KNOWLEDGE> from any of your monuments;\n\u2022 and draw 1 card.',
    ],
  },
  M27_MasudaIwafune: {
    type: 'megalith',
  ...
  P8_PyramidOfUserkaf: {
    ...
    lockedSpace: false,
    activation: 'decline',
    effect: ['Each of your opponents must discard 1 <ARTIFACT> from their board.'],
  },
  P9_Caral: {
    type: 'pyramid',
    number: 9,
  ...
  P12_GunungPadang: {
    ...
    lockedSpace: false,
    activation: 'decline',
    effect: ['Move another monument in your Timeline to any other available space.'],
  },
  P13_Yonaguni: {
    type: 'pyramid',
    number: 13,
  ...
  P20_BorobudurTemple: {
    ...
    lockedSpace: true,
    activation: 'anytime',
    effect: ['Each time you CREATE 1 <ARTIFACT>, you may LEARN 1 Technology if you fulfill its requirements.'],
  },
  P21_Phimeanakas: {
    type: 'pyramid',
    number: 21,
  ...
  A5_IcaStones: {
    ...
    discard: 0,
    activation: 'timeline',
    effect: ['If you have at least 3 <ARTIFACT> on your board, draw 1 card.'],
  },
  ...
  A7_MoaiStatue: {
    ...
    discard: 0,
    activation: 'timeline',
    effect: ['You may discard 2 <ARTIFACT> from your hand. If you do, draw 4 cards.'],
  },
  A8_LaManAPyramid: {
    number: 8,
...
var TECHS_DATA = {
  T1_Anaximenes: {
    ...
    type: 'ancient',
    level: 1,
    requirement: ['3 <ARTIFACT> on your board.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
  },
  T2_Aristotle: {
  ...
  T12_Mummification: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard as many <KNOWLEDGE> from your Timeline as the number of <ARTIFACT> on your board.'],
  },
  T13_MysterySchool: {
    number: 13,
    name: 'Mystery School',
  ...
  T28_Imhotep: {
    ...
    type: 'ancient',
    level: 2,
    requirement: ['4 <ARTIFACT> on your board.'],
    activation: 'endgame',
    effect: ['3 <VP>'],
  },
  T29_Plato: {
...
function formatTextIcons(rawText, white) {
  ...
  return rawText
    ...
    .replace(/<LOST_KNOWLEDGE>/gi, '<span class="icon lost-knowledge '.concat(whiteText, '"></span>'))
    ...
    .replace(/\[I\]/gi, '<span class="icon tech-level" data-level="1"></span>')
    .replace(/\[II\]/gi, '<span class="icon tech-level" data-level="2"></span>');
}
var CARD_COLORS = {
  A: '#734073',
  C: '#d66b2a',
...
var BuilderCardsManager = /** @class */ (function (_super) {
  ...
  BuilderCardsManager.prototype.setupFrontDiv = function (card, div, ignoreTooltip) {
    ...
    html += '\n        <div class="name-box">\n            <div class="name">\n                '
      ...
      .concat(
        (_b = card.country) !== null && _b !== void 0 ? _b : '',
        '</div>\n            </div>\n        </div>\n        <div class="effect"><div>'
      )
      .concat(
        (_d =
          (_c = card.effect) === null || _c === void 0
            ? void 0
            : _c
                .map(function (text) {
  ...
  BuilderCardsManager.prototype.reduceToFit = function (outerDiv, attemps) {
    ...
    if (attemps < 5) {
      attemps++;
      setTimeout(function () {
        return _this.reduceToFit(outerDiv, attemps);
      });
    }
  };
  ...
  BuilderCardsManager.prototype.getTooltip = function (card) {
    ...
    message += '\n        <br>\n        <strong>'
      ...
      .concat(
        this.generateCardDiv(__assign(__assign({}, card), { id: ''.concat(card.id, '--tooltip-card') })).outerHTML,
        '\n        '
      );
    return message;
  };
  ...
  BuilderCardsManager.prototype.getFullCard = function (card) {
    return __assign(__assign({}, CARDS_DATA[card.id]), {
      id: card.id,
...
var TechnologyTilesManager = /** @class */ (function (_super) {
  ...
  TechnologyTilesManager.prototype.setupFrontDiv = function (card, div, ignoreTooltip) {
    ...
    var html = '';
    if (requirement) {
      html += '<div class="requirement"><div>'.concat(
        (_b = card.requirement
          .map(function (text) {
            return formatTextIcons(text);
          })
    ...
    html += '<div class="name-box">\n            <div class="name">\n                '
      .concat(
        (_c = card.name) !== null && _c !== void 0 ? _c : '',
        '\n            </div>\n        </div>\n        <div class="effect">\n            <div>'
      )
      .concat(
        (_e =
          (_d = card.effect) === null || _d === void 0
            ? void 0
            : _d
                .map(function (text) {
                  return formatTextIcons(text);
...
var TableCenter = /** @class */ (function () {
  ...
  TableCenter.prototype.fillUpTechBoard = function (board, cards, args) {
    ...
    this.technologyTilesStocks[board].addCards(tiles, {
      fromStock: tiles.length
        ? this.technologyTilesDecks[(_a = tiles[0]) === null || _a === void 0 ? void 0 : _a.level]
        : undefined,
    });
    [1, 2].forEach(function (level) {
  ...
  TableCenter.prototype.setTileStocksSelectable = function (selectable) {
    ...
    stocks.forEach(function (stock) {
      return stock.classList.toggle('selectable', selectable);
    });
  };
...
var PastDeck = /** @class */ (function (_super) {
  ...
  function PastDeck(manager, element) {
    var _this =
      _super.call(this, manager, element, {
        verticalShift: '2px',
        horizontalShift: '2px',
        direction: 'mixed',
        counter: {
  ...
  PastDeck.prototype.resetPastOrder = function () {
    ...
    var unrotatedCards = cards.filter(function (card) {
      return !card.rotated;
    });
...
var PlayerTable = /** @class */ (function () {
  function PlayerTable(game, player) {
    ...
    html += '\n            <div id="player-table-'
      ...
      .concat(player.color, '">\n                <div id="player-table-')
      .concat(this.playerId, '-lost-knowledge" class="lost-knowledge-space"></div>\n                <div id="player-table-')
      .concat(this.playerId, '-lost-knowledge-counter" class="lost-knowledge-counter bga-cards_deck-counter round" data-empty="')
      .concat((!player.lostKnowledge).toString(), '">')
      .concat(player.lostKnowledge, '</div>\n                <div id="player-table-')
    ...
    this.timeline.onSelectionChange = function (selection) {
      return _this.game.onTimelineCardSelectionChange(selection, _this.playerId);
    };
    timelineSlotsIds
      .map(function (slotId) {
    ...
    this.artifacts.onSelectionChange = function (selection) {
      return _this.game.onArtifactSelectionChange(selection);
    };
    this.artifacts.onCardClick = function (card) {
      return _this.game.onArtifactCardClick(card);
    };
    ...
    this.past.onSelectionChange = function (selection) {
      return _this.game.onPastCardSelectionChange(selection);
    };
    ['ancient', 'writing', 'secret'].forEach(function (type) {
  ...
  PlayerTable.prototype.createTimelineCard = function (card) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.timeline.addCard(card)];
          case 1:
            promise = _a.sent();
  ...
  PlayerTable.prototype.createKnowledgeCounter = function (cardId, knowledge) {
    ...
    document
      .getElementById('builder-card-'.concat(cardId, '-front'))
      .insertAdjacentHTML(
        'beforeend',
        '\n            <div id="'
          .concat(
            cardId,
            '-token-counter" class="token-counter">\n                <div class="token-counter-info">\n                    <div class="token-number" id="'
          )
          .concat(cardId, '-token-counter-number">')
          .concat(
            knowledge,
            '</div>\n                    <div class="knowledge-token"></div>\n                </div>\n                <div class="token-counter-actions">\n                    <div class="token-action-info remove">-</div>\n                    <div class="token-action-info add">+</div>\n                    <div class="actions">\n                        <div class="action plus" id="'
          )
          .concat(
            cardId,
            '-token-counter-plus">\u25B2</div>\n                        <div class="selected-group">\n                            <div class="selected-number" id="'
          )
          .concat(
            cardId,
            '-token-counter-selected-number">0</div>\n                            <div class="knowledge-token"></div>\n                        </div>\n                        <div class="action minus" id="'
          )
          .concat(
            cardId,
            '-token-counter-minus">\u25BC</div>\n                    </div>\n                    <div class="token-selection">\uD83E\uDC46</div>\n                    <div class="future-number" id="'
          )
          .concat(cardId, '-token-counter-future-number">')
          .concat(
            knowledge,
            '</div>\n                    <div class="knowledge-token"></div>\n                </div>\n            </div>\n        '
          )
  ...
  PlayerTable.prototype.getCardKnowledge = function (cardId) {
    var _a;
    return Number(
      (_a = document.getElementById(''.concat(cardId, '-token-counter-number'))) === null || _a === void 0 ? void 0 : _a.innerHTML
    );
  };
  PlayerTable.prototype.getCardSelectedKnowledge = function (cardId) {
    var _a;
    return Number(
      (_a = document.getElementById(''.concat(cardId, '-token-counter-selected-number'))) === null || _a === void 0
        ? void 0
        : _a.innerHTML
    );
  };
  PlayerTable.prototype.setCardSelectedKnowledge = function (cardId, selectedKnowledge, initial) {
    ...
    document
      .getElementById(''.concat(cardId, '-token-counter-plus'))
      .classList.toggle('disabled', selectedKnowledge >= knowledge);
    document.getElementById(''.concat(cardId, '-token-counter-future-number')).innerHTML = ''.concat(
      knowledge + direction * selectedKnowledge
    );
    if (!initial) {
  ...
  PlayerTable.prototype.declineSlideLeft = function () {
    ...
    return this.timeline.addCards(shiftedCards, {
      animation: new BgaSlideAnimation({ duration: ANIMATION_MS * 3, transitionTimingFunction: 'ease-in-out' }),
    });
  };
  PlayerTable.prototype.enterSwap = function (cardIds, fixedCardId) {
    var _a;
    this.timeline.setSelectionMode(
      'multiple',
      this.game.builderCardsManager.getFullCardsByIds(
        cardIds.filter(function (id) {
          return id != fixedCardId;
        })
      )
    );
    if (fixedCardId) {
      var fixedCard = this.game.builderCardsManager.getFullCardById(fixedCardId);
      (_a = this.game.builderCardsManager.getCardElement(fixedCard)) === null || _a === void 0
        ? void 0
        : _a.classList.add('swapped-card');
    }
  };
  PlayerTable.prototype.leaveSwap = function () {
    this.timeline.setSelectionMode('none');
    Array.from(document.getElementsByClassName('swapped-card')).forEach(function (elem) {
      return elem.classList.remove('swapped-card');
    });
  };
  PlayerTable.prototype.swapCards = function (cards) {
    ...
    cards.forEach(function (card) {
      return _this.setCardKnowledge(card.id, card.knowledge);
    });
  };
  ...
  PlayerTable.prototype.rotateCards = function (cards) {
    var _this = this;
    cards.forEach(function (card) {
      return _this.game.builderCardsManager.updateCardInformations(card, { updateMain: true });
    });
    this.past.resetPastOrder();
  };
  return PlayerTable;
...
var CreateEngine = /** @class */ (function (_super) {
  ...
  CreateEngine.prototype.addConfirmDiscardSelection = function () {
    ...
    this.game.addPrimaryActionButton('confirmDiscardSelection_btn', _('Confirm discarded cards'), function () {
      return _this.game.onCreateCardConfirm(_this.data);
    });
    this.setConfirmDiscardSelectionState();
  };
  ...
  CreateEngine.prototype.getDiscardCount = function () {
    ...
    var slot =
      card.id[0] == 'A' || card.lockedSpace ? Object.keys(this.possibleCardsLocations[card.id])[0] : this.data.selectedSlot;
...
var RemoveKnowledgeEngine = /** @class */ (function (_super) {
        ...
        new FrontState(
          ...
          function (engine) {
            ...
            cardIds.forEach(function (cardId) {
              return _this.game.getCurrentPlayerTable().setCardSelectedKnowledge(cardId, 0, true);
            });
  ...
  RemoveKnowledgeEngine.prototype.addConfirmDiscardTokenSelection = function () {
    ...
    this.game.addPrimaryActionButton('confirmDiscardTokenSelection_btn', _('Confirm discarded tokens'), function () {
      return _this.game.onRemoveKnowledgeConfirm(_this.data.discardTokens);
    });
    this.setConfirmDiscardTokenSelectionState();
  };
  ...
  RemoveKnowledgeEngine.prototype.setConfirmDiscardTokenSelectionState = function () {
    var _this = this;
    var _a;
    var discardCount = Object.values(this.data.discardTokens).reduce(function (a, b) {
      return a + b;
    }, 0);
    //console.log(this.m, Object.values(this.data.discardTokens).filter(val => val > 0), discardCount, this.n * this.m);
    (_a = document.getElementById('confirmDiscardTokenSelection_btn')) === null || _a === void 0
      ? void 0
      : _a.classList.toggle(
          'disabled',
          discardCount > this.n * this.m ||
            (this.type === 'xor' &&
              Object.values(this.data.discardTokens).filter(function (val) {
                return val > 0;
              }).length > this.m) ||
            Object.keys(this.data.discardTokens).some(function (cardId) {
              return !_this.cardIds.includes(cardId);
            })
        );
  };
...
var MoveBuildingEngine = /** @class */ (function (_super) {
      ...
      _super.call(this, game, [
        new FrontState(
          ...
          function (engine) {
            ...
            if (engine.data.selectedCard) {
              engine.data.selectedCard.location = _this.game
                .getCurrentPlayerTable()
                .timeline.getCards()
                .find(function (card) {
                  return card.id == engine.data.selectedCard.id;
                }).location;
              (_b = _this.game.builderCardsManager.getCardElement(engine.data.selectedCard)) === null || _b === void 0
                ? void 0
                : _b.classList.add('created-card');
              _this.nextState('slot');
              return;
            }
            var selectableCards = _this.cardsIds.map(function (id) {
              return _this.game.builderCardsManager.getFullCardById(id);
            });
        ...
        new FrontState(
          ...
          function (engine) {
            ...
            var ignoreLocation =
              engine.data.selectedCard.location.substring(0, engine.data.selectedCard.location.length - 1) + '1';
            var locations = {};
            _this.slotsIds
              .filter(function (slotId) {
                return slotId != ignoreLocation;
              })
              .forEach(function (slotId) {
                return (locations[slotId] = 0);
              });
  ...
  MoveBuildingEngine.prototype.addCancel = function () {
    var _this = this;
    this.game.addSecondaryActionButton('restartMoveBuilding_btn', _('Restart card selection'), function () {
      return _this.nextState('init');
    });
  };
...
var PickDeckTechEngineData = /** @class */ (function () {
  function PickDeckTechEngineData(selectedTech, selectedDiscard, remainingToDiscard) {
    if (selectedTech === void 0) {
      selectedTech = null;
    }
    if (selectedDiscard === void 0) {
      selectedDiscard = [];
    }
    if (remainingToDiscard === void 0) {
      remainingToDiscard = [];
    }
...
var PickDeckTechEngine = /** @class */ (function (_super) {
      ...
      _super.call(this, game, [
        new FrontState(
          ...
          function (engine) {
            ...
            if (engine.data.selectedTech) {
              (_a = _this.game.technologyTilesManager.getCardElement(engine.data.selectedTech)) === null || _a === void 0
                ? void 0
                : _a.classList.remove('created-card');
            ...
            if (!learnableTechs.length) {
              _this.game.addPrimaryActionButton(
                'passTakeTechTile_btn',
                ''.concat(_('Pass'), ' (').concat(_('you cannot build a technology tile'), ')'),
                function () {
                  return _this.nextState('discard');
                }
              );
            }
          },
        ...
        new FrontState(
          ...
          function (engine) {
            ...
            engine.data.selectedDiscard = [];
            engine.data.remainingToDiscard = engine.data.selectedTech
              ? techs.filter(function (lt) {
                  return lt.id != engine.data.selectedTech.id;
                })
              : techs;
          ...
          function (engine) {
            ...
            engine.data.selectedDiscard.forEach(function (card) {
              return _this.setTechNumber(card, null);
            });
  ...
  PickDeckTechEngine.prototype.initMarketStock = function () {
    ...
    if (!this.market) {
      document
        .getElementById('table-center-and-market')
        .insertAdjacentHTML('afterbegin', '\n                <div id="market"></div>\n            ');
      this.market = new LineStock(this.game.technologyTilesManager, document.getElementById('market'));
      this.market.onCardClick = function (card) {
        return _this.onMarketClick(card);
      };
    }
  };
  PickDeckTechEngine.prototype.onMarketClick = function (card) {
    ...
    if (this.currentState === 'init') {
      if (
        this.learnableTechs.some(function (lt) {
          return lt.id == card.id;
        })
      ) {
        this.data.selectedTech = card;
        (_a = this.game.technologyTilesManager.getCardElement(card)) === null || _a === void 0
          ? void 0
          : _a.classList.add('created-card');
        this.nextState('discard');
      }
      ...
      if (
        this.data.remainingToDiscard.some(function (lt) {
          return lt.id == card.id;
        })
      ) {
  ...
  PickDeckTechEngine.prototype.addConfirmAndCancel = function () {
    var _this = this;
    this.game.addPrimaryActionButton('confirmPikDeckTech_btn', _('Put back in selected order'), function () {
      var _a, _b;
      return _this.game.onPickTechDeckConfirm(
        (_b = (_a = _this.data.selectedTech) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null,
        _this.data.selectedDiscard.map(function (card) {
          return card.id;
        })
      );
    });
    document.getElementById('confirmPikDeckTech_btn').classList.add('disabled');
    this.game.addSecondaryActionButton('restartPikDeckTech_btn', _('Restart'), function () {
      return _this.nextState('init');
    });
  };
...
var AncientKnowledge = /** @class */ (function () {
  ...
  AncientKnowledge.prototype.setup = function (gamedatas) {
    ...
    document.querySelector('html').dataset.bg =
      (_b = (_a = this.gamedatas.players[this.getPlayerId()]) === null || _a === void 0 ? void 0 : _a.color) !== null &&
      _b !== void 0
        ? _b
        : '6f3766';
  ...
  AncientKnowledge.prototype.onEnteringState = function (stateName, args) {
    ...
    if ((_d = args.args) === null || _d === void 0 ? void 0 : _d.source) {
      if (this.gamedatas.gamestate.descriptionmyturn.search('{source}') === -1) {
        if (args.args.sourceId) {
          ...
          $('pagemaintitletext').insertAdjacentHTML(
            'beforeend',
            ' (<span class="title-log-card-name" id="tooltip-'
              .concat(this._last_tooltip_id, '">')
              .concat(_(args.args.source), '</span>)')
          );
    ...
    if (/* TODO? this._activeStates.includes(stateName) ||*/ this.isCurrentPlayerActive()) {
      ...
      // Undo last steps
      (_g = (_f = args.args) === null || _f === void 0 ? void 0 : _f.previousSteps) === null || _g === void 0
        ? void 0
        : _g.forEach(function (stepId) {
    ...
    if (this.isCurrentPlayerActive() && args.args) {
      // Anytime buttons
      (_k = args.args.anytimeActions) === null || _k === void 0
        ? void 0
        : _k.forEach(function (action, i) {
            var msg = action.desc;
            ...
            _this.addPrimaryActionButton(
              ...
              msg,
              function () {
                return _this.takeAction('actAnytimeAction', { id: i } /*, false*/);
              },
              'anytimeActions'
            );
          });
  ...
  AncientKnowledge.prototype.onEnteringResolveChoice = function (args) {
    var _this = this;
    if (this.isCurrentPlayerActive()) {
      Object.values(args.choices).forEach(function (choice) {
        return _this.addActionChoiceBtn(choice, false);
      });
      Object.values(args.allChoices).forEach(function (choice) {
        return _this.addActionChoiceBtn(choice, true);
      });
      var selectableCards = this.builderCardsManager.getFullCardsByIds(
        Object.values(args.choices)
          .filter(function (choice) {
            var _a;
            return (_a = choice.args) === null || _a === void 0 ? void 0 : _a.cardId;
          })
          .map(function (choice) {
            return choice.args.cardId;
          })
      );
  ...
  AncientKnowledge.prototype.onEnteringDrawAndKeep = function (args) {
    ...
    var cards = ((_a = args._private) === null || _a === void 0 ? void 0 : _a.cardIds)
      ? this.builderCardsManager.getFullCardsByIds(
          (_c = (_b = args._private) === null || _b === void 0 ? void 0 : _b.cardIds) !== null && _c !== void 0 ? _c : []
        )
      : Array.from(Array(args.n)).map(function (_, index) {
    ...
    if (!this.drawAndPeekStock) {
      ...
      this.drawAndPeekStock.onSelectionChange = function (selection) {
        ...
        (_a = document.getElementById('actDrawAndKeep_button')) === null || _a === void 0
          ? void 0
          : _a.classList.toggle('disabled', selection.length != m);
      };
    }
    cards.forEach(function (card) {
  ...
  AncientKnowledge.prototype.onEnteringMoveBuilding = function (args) {
    if (this.isCurrentPlayerActive()) {
      this.moveBuildingEngine = new MoveBuildingEngine(
        this,
        Object.values(args.cardIds),
        args.card_id,
        Object.values(args.slots)
      );
    }
  };
  ...
  AncientKnowledge.prototype.initMarketStock = function () {
    ...
    if (!this.market) {
      ...
      this.market.onSelectionChange = function (selection) {
        return _this.onMarketSelectionChange(selection);
      };
    }
  };
  ...
  AncientKnowledge.prototype.onEnteringSpecialEffect = function (args) {
    ...
    if (args.description && args.descriptionmyturn) {
      ...
      $('pagemaintitletext').insertAdjacentHTML(
        'beforeend',
        ' (<span class="title-log-card-name" id="tooltip-'.concat(this._last_tooltip_id, '">').concat(_(args.source), '</span>)')
      );
      this.setTooltip('tooltip-'.concat(this._last_tooltip_id), card.name);
      this._last_tooltip_id++;
    }
    ...
    if (this.isCurrentPlayerActive()) {
      switch (args.sourceId) {
        ...
        case 'P7_PyramidOfTheNiches':
          this.pickDeckTechEngine = new PickDeckTechEngine(
            this,
            this.technologyTilesManager.getFullCardsByIds(args._private.techIds),
            this.technologyTilesManager.getFullCardsByIds(args._private.learnableTechIds)
          );
          break;
        case 'P13_Yonaguni':
          this.getCurrentPlayerTable().artifacts.setSelectionMode(
            'multiple',
            this.builderCardsManager.getFullCardsByIds(args.cardIds)
          );
          break;
        case 'T17_EarthquakeEngineering':
          this.getCurrentPlayerTable().setHandSelectable(
            'multiple',
            this.builderCardsManager.getFullCardsByIds(args._private.cardIds)
          );
          break;
        ...
        case 'T27_LatinAlphabet':
          this.tableCenter.setTechnologyTilesSelectable(
            true,
            this.technologyTilesManager.getFullCardsByIds(args._private.techIds)
          );
          break;
  ...
  AncientKnowledge.prototype.onEnteringDiscard = function (args) {
    ...
    var selectableCards =
      cardsIds === null || cardsIds === void 0
        ? void 0
        : cardsIds.map(function (id) {
            return _this.builderCardsManager.getFullCardById(id);
          });
    var playerTable = this.getCurrentPlayerTable();
    if (
      playerTable.hand.getCards().some(function (card) {
    ...
    if (
      playerTable.artifacts.getCards().some(function (card) {
        return cardsIds.includes(card.id);
      })
    ) {
  ...
  AncientKnowledge.prototype.onEnteringEndScore = function (fromReload) {
    ...
    players.forEach(function (player) {
      document
        .getElementById('scoretr')
        .insertAdjacentHTML(
          'beforeend',
          '<th class="player_name" style="color: #'.concat(player.color, '">').concat(player.name, '</th>')
        );
    });
    document.getElementById('score-table-body').innerHTML = ['past', 'effects', 'techs', 'timeline', 'knowledge', 'total']
      .map(function (field) {
        return '<tr class="score-'.concat(field, '">').concat(
          players
            .map(function (player) {
              return '<td id="score-'.concat(field, '-').concat(player.id, '"></td>');
            })
            .join(''),
          '</tr>'
        );
    ...
    if (fromReload) {
      players
        ...
        .forEach(function (playerId) {
          return _this.addPlayerSummaryColumn(playerId, _this.gamedatas.scores[playerId]);
        });
    }
  };
  AncientKnowledge.prototype.addPlayerSummaryColumn = function (playerId, playerScore) {
    ['past', 'effects', 'techs', 'timeline', 'knowledge', 'total'].forEach(function (field) {
  ...
  AncientKnowledge.prototype.onLeavingAddKnowledge = function () {
    this.playersTables.forEach(function (playerTable) {
      return playerTable.timeline.setSelectionMode('none');
    });
  };
      ...
      switch (stateName) {
        ...
        case 'chooseAction':
          ACTIONS.map(function (action) {
            return _this.getActionInformations(action);
          }).forEach(function (actionInformations) {
            _this.addActionButton(
              'actChooseAction_'.concat(actionInformations[0], '_button'),
              '<div class="action-icon '.concat(actionInformations[0], '"></div> ').concat(actionInformations[1]),
              function () {
                return _this.takeAtomicAction('actChooseAction', [actionInformations[0]]);
              }
            );
          ...
          if (
            !table.past.getCards().filter(function (card) {
              return !card.rotated;
            }).length
          ) {
          ...
          break;
        case 'swap':
          this.addActionButton('actSwap_button', _('Swap selected cards'), function () {
            return _this.actSwap();
          });
          document.getElementById('actSwap_button').classList.add('disabled');
          break;
        case 'excavate':
          this.addActionButton('actExcavate_button', _('Excavate selected cards'), function () {
            return _this.actExcavate();
          });
        ...
        case 'discardMulti':
          ...
          this.addActionButton('actDiscard_button', _('Discard selected cards'), function () {
            return _this.actDiscard(stateName == 'discardMulti');
          });
          document.getElementById('actDiscard_button').classList.add('disabled');
          if ((_a = args._private) === null || _a === void 0 ? void 0 : _a.canSkip) {
            this.addSecondaryActionButton('actSkipDiscard_button', _('Pass'), function () {
              return _this.actDiscard(stateName == 'discardMulti');
            });
          }
          break;
        ...
        case 'confirmPartialTurn':
          this.addActionButton('actConfirmPartialTurn_button', _('Confirm'), function () {
            return _this.actConfirmPartialTurn();
          });
          this.startActionTimer('actConfirmPartialTurn_button');
          break;
        case 'drawAndKeep':
          this.addActionButton('actDrawAndKeep_button', _('Keep selected card(s)'), function () {
            return _this.actDrawAndKeep();
          });
          document.getElementById('actDrawAndKeep_button').classList.add('disabled');
          break;
        case 'addKnowledge':
          this.addActionButton(
            'actAddKnowledge_button',
            formatTextIcons(_('Add ${n} <LOST_KNOWLEDGE> to selected cards').replace('${n}', args.n), true),
            function () {
              return _this.actAddKnowledge();
            }
          );
        ...
        case 'addKnowledgeFromBoard':
          this.addActionButton(
            'actAddKnowledgeFromBoard_button',
            formatTextIcons(_('Add ${n} <LOST_KNOWLEDGE> to selected cards').replace('${n}', args.n), true),
            function () {
              return _this.actAddKnowledgeFromBoard();
            }
          );
              ...
              case 'M14_MenhirOfKerloas':
                if (specialEffectArgs.pIds) {
                  specialEffectArgs.pIds.forEach(function (playerId) {
                    ...
                    //url = url.replace('_32', url.indexOf('data/avatar/defaults') > 0 ? '' : '_184');
                    _this.addActionButton(
                      'actChooseOpponent'.concat(playerId, '-button'),
                      '<div class="player-avatar" style="background-image: url(\''
                        .concat(url, '\');"></div> ')
                        .concat(player.name, '</div>'),
                      function () {
                        return _this.takeAtomicAction('actChooseOpponent', [playerId]);
                      }
                    );
                    document.getElementById('actChooseOpponent'.concat(playerId, '-button')).style.border = '3px solid #'.concat(
                      player.color
                    );
                  });
                } else {
                  this.addActionButton('actStealCard_button', _('Keep selected card'), function () {
                    return _this.actStealCard();
                  });
                  document.getElementById('actStealCard_button').classList.add('disabled');
                }
                break;
              case 'P13_Yonaguni':
                this.addActionButton('actDiscardAndRemoveKnowledge_button', _('Discard selected cards'), function () {
                  return _this.actDiscardAndRemoveKnowledge();
                });
                break;
              case 'T3_HermesTrismegistus':
                this.addActionButton('actChooseCardToKeep_button', _('Keep selected card'), function () {
                  return _this.actChooseCardToKeep();
                });
                document.getElementById('actChooseCardToKeep_button').classList.add('disabled');
                if (specialEffectArgs.canSkip) {
                  this.addSecondaryActionButton('actSkipChooseCardToKeep_button', _('Pass'), function () {
                    return this.takeAtomicAction('actPassChooseCardToKeep', []);
                  });
                }
                break;
              case 'T17_EarthquakeEngineering':
                this.addActionButton('actDiscardAndDraw_button', _('Discard selected cards'), function () {
                  return _this.actDiscardAndDraw();
                });
                break;
              case 'T22_AncientGreek':
                if ((_b = specialEffectArgs._private) === null || _b === void 0 ? void 0 : _b.canCreate) {
                  this.addActionButton('actPickAndDiscard_button', _('Build selected artifact'), function () {
                    return _this.actPickAndDiscard();
                  });
                  document.getElementById('actPickAndDiscard_button').classList.add('disabled');
                } else {
                  this.addActionButton(
                    'actPickAndDiscard_button',
                    ''.concat(_('Pass'), ' (').concat(_('you cannot build an artifact'), ')'),
                    function () {
                      return _this.actPickAndDiscard(null);
                    }
                  );
                }
                break;
  ...
  AncientKnowledge.prototype.addActionChoiceBtn = function (choice, disabled) {
    ...
    this.addSecondaryActionButton(
      ...
      disabled
        ? function () {}
        : function () {
            _this.askConfirmation(choice.irreversibleAction, function () {
              return _this.takeAction('actChooseAction', { id: choice.id });
            });
          }
    );
    if (disabled) {
  ...
  AncientKnowledge.prototype.startActionTimer = function (buttonId, time) {
    ...
    actionTimerFunction();
    this.actionTimerId = window.setInterval(function () {
      return actionTimerFunction();
    }, 1000);
  };
  ...
  AncientKnowledge.prototype.createPlayerPanels = function (gamedatas) {
    ...
    Object.values(gamedatas.players).forEach(function (player) {
      ...
      document
        .getElementById('player_score_'.concat(player.id))
        .insertAdjacentHTML('beforebegin', '<div id="player_score_'.concat(player.id, '-icon" class="vp icon"></div>'));
      ...
      var html = '<div class="counters">\n                <div id="playerhand-counter-wrapper-'
        ...
        .concat(
          player.no == 1 ? '<div id="first-player"></div>' : '',
          '</div>\n            </div>\n            <div class="icons counters">'
        );
      html += ICONS_COUNTERS_TYPES.map(function (type) {
        return '\n                <div id="'
          .concat(type, '-counter-wrapper-')
          .concat(player.id, '">\n                    <div class="')
          .concat(type, ' icon"></div>\n                    <span id="')
          .concat(type, '-counter-')
          .concat(player.id, '"></span>\n                </div>\n            ');
      ...
      ICONS_COUNTERS_TYPES.forEach(function (type) {
        ...
        if (artifact) {
          ...
          _this.setTooltip(
            ''.concat(type, '-counter-wrapper-').concat(player.id),
            _('${type} cards in the past (${type} cards in the timeline)').replace(/\${type}/g, typeName)
          );
        }
      });
    });
    ...
    switch (action) {
      case 'create':
        return [
          'create',
          _('Create'),
          formatTextIcons(_('<strong>Play</strong> 1 <CITY>, <MEGALITH>, <PYRAMID> or <ARTIFACT> card.')),
        ];
      case 'learn':
        return [
          'learn',
          _('Learn'),
          formatTextIcons(_('<strong>Take</strong> 1 <ANCIENT>, <WRITING> or <SECRET> Technology card.')),
        ];
      case 'archive':
        return [
          'archive',
          _('Archive'),
          formatTextIcons(
            _('<strong>Discard</strong> 1 <KNOWLEDGE> from 1 any of your <i>monuments</i> for each card discarded.')
          ),
        ];
      case 'excavate':
        return ['excavate', _('Excavate'), _('<strong>Draw</strong> 2 Builder cards for each card in your Past you rotate.')];
      case 'search':
        return ['search', _('Search'), _('<strong>Draw</strong> 1 Builder card.')];
    }
  };
  AncientKnowledge.prototype.getHelpActionsHtml = function () {
    var _this = this;
    var html = '\n        <div id="help-action-popin">\n            <h1>'
      .concat(_('Actions (any 2)'), '</h1>\n            ')
      .concat(
        ACTIONS.map(function (action) {
          return _this.getActionInformations(action);
        })
          .map(function (actionInformations, index) {
            return '<div class="action" data-index="'
              .concat(index, '">\n                <div class="name">')
              .concat(actionInformations[1], '</div>\n                <div class="description">')
              .concat(actionInformations[2], '</div>\n                </div>');
          })
          .join(''),
        '\n        </div>'
      );
  ...
  AncientKnowledge.prototype.getHelpTurnHtml = function () {
    var html = '\n        <div id="help-turn-popin">\n            <h1 class="overview">'
      .concat(_('TURN OVERVIEW'), '</h1>\n            <div class="phase a">\n                <h1>')
      .concat(_('A. ACTION PHASE'), '</h1>\n                <div class="description">')
      .concat(_('Any 2 actions.'), '</div>\n            </div>\n            <div class="phase b">\n                <h1>')
      .concat(_('B. TIMELINE PHASE'), '</h1>\n                <div class="description">')
      .concat(
        _('Activate all your cards with the symbol <TIMELINE> in any order.').replace(
          '<TIMELINE>',
          '<div class="timeline icon"></div>'
        ),
        '</div>\n            </div>\n            <div class="phase c">\n                <h1>'
      )
      .concat(_('C. DECLINE PHASE'), '</h1>\n                <div class="description">')
      .concat(
        _('Slide all the monuments in your Timeline to the left.'),
        '</div>\n            </div>\n            <h1 class="end">'
      )
      .concat(_('END OF THE GAME'), '</h1>\n        </div>');
    return html;
  };
  AncientKnowledge.prototype.onTableTechnologyTileClick = function (tile, showWarning) {
    var _this = this;
    if (showWarning === void 0) {
      showWarning = true;
    }
    if (this.gamedatas.gamestate.name == 'learn') {
      ...
      if (warning) {
        this.askConfirmation(_('the technology tiles will be refilled with new tiles'), function () {
          return _this.onTableTechnologyTileClick(tile, false);
        });
      } else {
      ...
      switch (this.gamedatas.gamestate.args.sourceId) {
        case 'P35_CandiKethek':
        case 'T27_LatinAlphabet':
          this.takeAtomicAction('actChooseTech', [tile.id]);
          break;
      }
    }
  };
  ...
  AncientKnowledge.prototype.onMarketSelectionChange = function (selection) {
    ...
    if (this.gamedatas.gamestate.name == 'specialEffect') {
      switch (this.gamedatas.gamestate.args.sourceId) {
        case 'M14_MenhirOfKerloas':
          (_a = document.getElementById('actStealCard_button')) === null || _a === void 0
            ? void 0
            : _a.classList.toggle('disabled', selection.length != 1);
          break;
        case 'T3_HermesTrismegistus':
          (_b = document.getElementById('actChooseCardToKeep_button')) === null || _b === void 0
            ? void 0
            : _b.classList.toggle('disabled', selection.length != 1);
          break;
        case 'T22_AncientGreek':
          (_c = document.getElementById('actPickAndDiscard_button')) === null || _c === void 0
            ? void 0
            : _c.classList.toggle('disabled', selection.length != 1);
          break;
      }
    }
  };
  AncientKnowledge.prototype.onDiscardSelectionChange = function () {
    ...
    var selection = __spreadArray(
      __spreadArray([], this.getCurrentPlayerTable().hand.getSelection(), true),
      this.getCurrentPlayerTable().artifacts.getSelection(),
      true
    );
  ...
  AncientKnowledge.prototype.onTimelineCardSelectionChange = function (selection, playerId) {
    ...
    if (this.gamedatas.gamestate.name == 'swap') {
      ...
      var expectedNumber = Object.values(cardIdsPerPlayer_1).filter(function (cardIds) {
        return cardIds.length > 0;
      }).length;
      var currentNumber = Object.values(this.addKnowledgeSelection).filter(function (cardId) {
  ...
  AncientKnowledge.prototype.onTimelineSlotClick = function (slotId) {
    ...
    if (this.gamedatas.gamestate.name == 'create') {
      ...
      this.takeAtomicAction('actMoveBuilding', [this.moveBuildingEngine.data.selectedCard.id, slotId]);
    }
  };
  ...
  AncientKnowledge.prototype.onPickTechDeckConfirm = function (selectedTechId, discard) {
    this.takeAtomicAction('actChooseTechAndScrapOthers', [selectedTechId, discard]);
  };
  ...
  AncientKnowledge.prototype.resolveChoiceCardClicked = function (card) {
    var _this = this;
    var choice = Object.values(this.gamedatas.gamestate.args.choices).find(function (choice) {
      var _a;
      return ((_a = choice.args) === null || _a === void 0 ? void 0 : _a.cardId) == card.id;
    });
    if (choice) {
      this.askConfirmation(choice.irreversibleAction, function () {
        return _this.takeAction('actChooseAction', { id: choice.id });
      });
    }
  };
  ...
  AncientKnowledge.prototype.actDiscard = function (multi) {
    var selectedCards = __spreadArray(
      __spreadArray([], this.getCurrentPlayerTable().hand.getSelection(), true),
      this.getCurrentPlayerTable().artifacts.getSelection(),
      true
    );
  ...
  AncientKnowledge.prototype.actPickAndDiscard = function (pass) {
    ...
    this.takeAtomicAction('actPickAndDiscard', [
      pass ? null : (_a = selectedCards[0]) === null || _a === void 0 ? void 0 : _a.id,
    ]);
  };
  ...
  AncientKnowledge.prototype.notif_keep = function (args) {
    ...
    return card
      ? (_a = this.getPlayerTable(player_id).hand) === null || _a === void 0
        ? void 0
        : _a.addCard(this.builderCardsManager.getFullCard(card))
      : Promise.resolve(true);
  };
  AncientKnowledge.prototype.notif_discardCards = function (args) {
    var player_id = args.player_id,
      n = args.n,
      fromBoard = args.fromBoard;
    if (!fromBoard) {
      this.handCounters[player_id].incValue(-Number(n));
    }
  };
  ...
  AncientKnowledge.prototype.notif_addKnowledge = function (args) {
    var _this = this;
    Object.values(args.cards).forEach(function (card) {
      return _this.playersTables
        .find(function (playerTable) {
          return playerTable.timeline.getCards().some(function (c) {
            return c.id == card.id;
          });
        })
        .setCardKnowledge(card.id, card.knowledge);
    });
  };
  ...
  AncientKnowledge.prototype.notif_removeKnowledge = function (args) {
    ...
    Object.values(args.cards).forEach(function (card) {
      return table.setCardKnowledge(card.id, card.knowledge);
    });
  };
  ...
  AncientKnowledge.prototype.notif_midGameReached = function (args) {
    var _this = this;
    return this.notif_clearTechBoard(args).then(function () {
      return _this.tableCenter.midGameReached(args.board);
    });
  };
  ...
  AncientKnowledge.prototype.notif_endOfGameTriggered = function (animate) {
    ...
    dojo.place(
      '<div id="last-round">\n            <span class="last-round-text '
        .concat(animate ? 'animate' : '', '">')
        .concat(_('This is the final round!'), '</span>\n        </div>'),
      'page-title'
    );
  };
  ...
  AncientKnowledge.prototype.notif_updateScores = function (args) {
    ...
    Object.entries(args.scores).forEach(function (_a) {
      ...
      var tooltip = '\n                <div>'
        .concat(_('Cards in the past:'), ' <strong>')
        .concat(score.past.total, '</strong></div>\n                <div>')
        .concat(_('Cards effects in the past:'), ' <strong>')
        .concat(score.effects.total, '</strong></div>\n                <div>')
        .concat(_('Technology tiles:'), ' <strong>')
        .concat(score.techs.total, '</strong></div>\n                <div>')
        .concat(_('Monuments remaining in timeline:'), ' <strong>')
        .concat(score.timeline.total, '</strong></div>\n                <div>')
        .concat(_('Lost knowledge:'), ' <strong>')
        .concat(score.knowledge.total, '</strong></div>\n                <div><strong>')
        .concat(_('Total:'), ' ')
        .concat(score.total, '</strong></div>\n            ');
          ...
          if (args.urls.length > 1) {
            ...
            dojo.xhrGet({
              ...
              error: function (error) {
                return console.log('Error while loading : ', error);
              },
            });
          }
        },
