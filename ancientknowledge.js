...
var AncientKnowledge = /** @class */ (function () {
      ...
      switch (stateName) {
        ...
        case 'discardMulti':
          ...
          if (args._private && args._private.canSkip) {
            this.addSecondaryActionButton(`actSkipDiscard_button`, _('Pass'), () => this.actDiscard(stateName == 'discardMulti'));
          }
          break;
        case 'confirmTurn':
  ...
  AncientKnowledge.prototype.notif_keepAndDiscard = function (args) {
    var player_id = args.player_id,
      card = args.card;
    this.handCounters[player_id].incValue(1);
    return card ? this.getPlayerTable(player_id).hand.addCard(this.builderCardsManager.getFullCard(card)) : Promise.resolve(true);
  };
